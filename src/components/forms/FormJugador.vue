<template>
    <div class="p-6 max-w-5xl mx-auto">
        <h2 class="text-2xl font-semibold mb-2">Registro de Jugador</h2>

        <form class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white border border-gray-200 rounded-lg shadow-xl p-6">
            <!-- Nombre -->
            <div>
            ...
            <div>
                ...
                <input type="text" v-model="jugador.apellido"
                    class="w-full border rounded-lg p-2 focus:outline-none focus:ring focus:ring-blue-300" />
            </div>
            ...
            <div>
                ...
                <input type="text" v-model="jugador.dni"
                    class="w-full border rounded-lg p-2 focus:outline-none focus:ring focus:ring-blue-300" />
            </div>
            ...
            <div>
                ...
                <input type="date" v-model="jugador.fechaNacimiento"
                    class="w-full border rounded-lg p-2 focus:outline-none focus:ring focus:ring-blue-300" />
            </div>
            ...
            <div>
                ...
                <input type="text" v-model="jugador.nacionalidad"
                    class="w-full border rounded-lg p-2 focus:outline-none focus:ring focus:ring-blue-300" />
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" v-model="jugador.club"
                    class="w-full border rounded-lg p-2 focus:outline-none focus:ring focus:ring-blue-300" />
            </div>
...
const guardarJugador = () => {
    // Lógica para guardar el jugador
};
</script>