            ...
            <div class="flex items-center justify-evenly p-8 bg-white rounded-t-lg text-lg" v-if="active">
                ...
                <div class="flex items-center justify-center gap-4">
                    <label for="radio">Buscar Nombre
                        <input name="tipoBusqueda" type="radio" id="radio" v-model="tipoBusqueda"
                            value="nombre"></label>
                        ...
                        <div class="flex items-start space-x-6">
                            <div class="w-3/6">
                                ...
                                <form class="space-y-4">
                                    ...
                                    <div>
                                        <label for="system"
                                            class="block text-sm font-medium text-gray-700">Sistema:</label>
                                ...
                                <form class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label for="ageCategory"
                                            class="block text-sm font-medium text-gray-700">Categoría
                                            de
                                            edad:</label>
                                    ...
                                    <div>
                                        <label for="birthDate" class="block text-sm font-medium text-gray-700">Fecha
                                            Nac.
                                            desde:</label>
                                    ...
                                    <tbody>
                                        <tr v-for="(partido, index) in partidos" :key="partido.idPartido"
                                            ...
                                            <td class="px-4 py-2"> <button
                                                    @click="redireccionarPartido(torneo.codigoTorneo, partido.fechaTorneo, partido.local, partido.visitante, partido.idPartido)"
                                                    class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded inline-flex items-center gap-2">
...
const buscarFixture = async () => {
    const res = await axios.get('http://localhost:8080/api/torneo/fixture?idTorneo=' + torneo.value.id, {
        headers: {
            'Content-Type': 'application/json',
        },
    })
...
const redireccionarPartido = (codigoTorneo, fechaTorneo, local, visitante, idPartido) => {
    router.push({
        name: 'partidos',
        query: {
