<template>
  <div class="p-6">
    <h2 class="text-2xl font-semibold mb-6 capitalize">
      Buscar {{ route.params.tipo }}
    </h2>
    <div
      class="mt-6 max-w-7xl mx-auto bg-white rounded-2xl shadow-lg border h-full overflow-y-auto"
    >
      <!-- Tabs -->
...
const tabs = ["Partido", "Sancion"];
const activeTab = ref("Partido");
